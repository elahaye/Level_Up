...
function loadComplete() {
    ...
    function validateForm(event) {
        ...
        function verifyLengthField(name, tag, field, number)
        {
            ...
            {
                field.innerHTML = "Le champ '" + name + "' doit comporter " + number + " caractères.";
                tag.classList.add("red");
                 event.preventDefault();
            }
            else
        ...
        function verifyLengthPassword(name, tag, field)
        {
            ...
            {
                field.innerHTML = "Le champ '" + name + "' doit comporter au minimum 8 caractères.";
                tag.classList.add("red");
                event.preventDefault();
            }
            else
    ...
    function nicknameOnKeyUp()
    {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(nicknameKey == true)
                {
                    form[2].selector.innerHTML = "Ce pseudonyme est déjà utilisé, veuillez en sélectionner un autre.";
    ...
    function emailOnKeyUp()
    {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(emailKey == true)
                {
                    form[7].selector.innerHTML = "Ce mail est déjà utilisé, veuillez en sélectionner un autre.";
