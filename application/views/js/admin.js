...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tinymce.init({
      ...
      font_formats: 'EB Garamond=EB Garamond; Arial=arial,helvetica,sans-serif; Courier New=courier new,courier,monospace',
      language: 'fr_FR'
    });
    ...
    var deleteArticle = document.querySelectorAll('#listArticles .delete-article');
    ...
    {
        let confirmation = confirm("Souhaitez-vous modifier le status de cet utilisateur?");
            if (!confirmation) {
